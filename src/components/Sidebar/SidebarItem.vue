...
<template>
  <li>
    <router-link
      :to="item.route"
      class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-purple-800"
      @click.prevent="handleItemClick"
      :class="{
        'bg-purple-700': sidebarStore.page === item.label
      }"
    >
